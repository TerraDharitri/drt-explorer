...
import { r as n, L as d } from "./vendor-DKx09kD0.js";
...
const c = () => {
  const [c, m] = n.useState([]),
    ...
    D = [
      ...
      },
      {
        ...
        category: "social",
        url: "https://metasocial.network",
        logo: "https://placehold.co/200x200/ef4444/ffffff?text=Social",
        users: 68e3,
        tvl: 58e5,
        volume24h: 24e4,
        popularityScore: 79,
      ...
      },
      {
        ...
        category: "games",
        url: "https://metaworlds.game",
        logo: "https://placehold.co/200x200/14b8a6/ffffff?text=Worlds",
        users: 38e3,
        tvl: 72e5,
        volume24h: 42e4,
        popularityScore: 70,
  ...
  n.useEffect(() => {
    (async () => {
      x(!0), f(null);
      try {
        let e = "all" === u ? [...D] : D.filter((e) => e.category === u);
        if ("" !== y.trim()) {
        ...
        e.sort((e, t) => {
          ...
          switch (b) {
            ...
            case "tvl":
              ...
              break;
            case "volume":
              (a = e.volume24h), (s = t.volume24h);
              break;
            default:
              (a = e.popularityScore), (s = t.popularityScore);
          }
          if ("string" == typeof a) {
            const e = a.localeCompare(s);
            return "asc" === N ? e : -e;
          }
          return "asc" === N ? a - s : s - a;
        }),
          setTimeout(() => {
            m(e), x(!1);
          }, 600);
      } catch (e) {
        f("Failed to fetch dApps"), x(!1);
      }
    })();
  }, [u, y, b, N]);
  const z = (e) => {
      b === e ? w("asc" === N ? "desc" : "asc") : (j(e), w("desc"));
    },
    F = (e) =>
      e >= 1e9
        ? "$" + (e / 1e9).toFixed(2) + "B"
    ...
    A = (t) =>
      b !== t
        ? null
        : "asc" === N
        ? e.jsx(l, { className: "ml-1" })
        : e.jsx(o, { className: "ml-1" });
  return p
    ? e.jsxs("div", {
        ...
        children: [
          e.jsx("h1", {
            ...
            children: "Decentralized Applications",
          }),
          e.jsx("div", {
        ...
        children: [
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsxs("form", {
                    ...
                    children: [
                      e.jsx("input", {
                        ...
                        className:
                          "pl-10 pr-4 py-2 w-full rounded-lg bg-gray-100 dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-primary",
                      }),
                      e.jsx(t, {
                  ...
                  e.jsx("button", {
                    onClick: () => S(!k),
                    className:
                      "p-2 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700",
                    children: e.jsx(a, {
                      className: k ? "text-primary" : "text-gray-500",
                    }),
                  }),
                ],
              }),
            ...
            e.jsxs("div", {
              ...
              children: [
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsxs("button", {
                      onClick: () => z("popularity"),
                      className:
                        "px-3 py-1 rounded-md text-sm flex items-center " +
                        ("popularity" === b
                          ? "bg-primary text-white"
                          : "bg-white dark:bg-gray-700"),
                      children: ["Popularity ", A("popularity")],
                    }),
                    e.jsxs("button", {
                      onClick: () => z("name"),
                      className:
          ...
          e.jsxs("p", {
            ...
            children: [
              ...
              c.length,
              " ",
              1 === c.length ? "application" : "applications",
            ],
          }),
          e.jsx("div", {
                    ...
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsx("div", {
                            className:
                              "w-16 h-16 mr-4 flex-shrink-0 overflow-hidden rounded-lg",
                            children: e.jsx("img", {
                              src: t.logo,
                              alt: t.name,
                          ...
                          e.jsxs("div", {
                            children: [
                              ...
                              e.jsx("span", {
                                className:
                                  "inline-block px-2 py-1 text-xs bg-gray-100 dark:bg-gray-800 rounded-full mt-1 capitalize",
                                children: t.category,
                              }),
                            ],
                          }),
                      ...
                      e.jsx("p", {
                        className:
                          "mt-4 text-sm text-gray-600 dark:text-gray-400 line-clamp-2",
                        ...
                        children: [
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsxs("div", {
                                className:
                                  "flex items-center justify-center text-gray-500 mb-1",
                                children: [
                                  e.jsx(r, { size: 12, className: "mr-1" }),
                                  e.jsx("span", {
                                    className: "text-xs",
                                    children: "Users",
                                  }),
                            ...
                            children: [
                              e.jsxs("div", {
                                className:
                                  "flex items-center justify-center text-gray-500 mb-1",
                                children: [
                                  e.jsx(i, { size: 12, className: "mr-1" }),
                                  e.jsx("span", {
                                    className: "text-xs",
                                    children: "TVL",
                                  }),
                      ...
                      e.jsx("div", {
                        className: "mt-4 text-xs text-gray-500 truncate",
                        children: e.jsx("span", {
          ...
          0 === c.length &&
            e.jsxs("div", {
              className:
                "bg-gray-50 dark:bg-gray-800 rounded-lg p-6 text-center",
              children: [
                e.jsx("p", {
                  className: "text-gray-500 dark:text-gray-400",
                  children: "No dApps found matching your criteria.",
                }),
                e.jsx("button", {
                  onClick: () => {
                    v(""), g("all");
